...
import { Leaf, BarChart3, Settings, Factory, FlaskConical, Menu, MapPin, Phone, Mail } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-24 md:py-32 bg-slate-900 overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=2000&auto=format&fit=crop')] bg-cover bg-center"></div>
      ...
      <section className="py-24 bg-white">
        <div className="container px-4 mx-auto max-w-7xl">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-slate-100 rounded-3xl h-[500px] flex items-center justify-center relative overflow-hidden group">
              <img 
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="p-10 rounded-3xl bg-slate-50 border border-slate-100">
              <div className="flex items-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-slate-900">생산 설비 (Factory)</h3>
              </div>
              <ul className="space-y-4">
                <li className="flex items-center justify-between p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
                  <span className="font-bold text-slate-700">배합기 (8t)</span>
                  <span className="text-slate-500 font-medium">2대</span>
                </li>
                <li className="flex items-center justify-between p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
                  <span className="font-bold text-slate-700">정밀배합기 (600kg)</span>
                  <span className="text-slate-500 font-medium">2대</span>
                </li>
                <li className="flex items-center justify-between p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
                  <span className="font-bold text-slate-700">시편제작용 사출기 (150kg)</span>
                  <span className="text-slate-500 font-medium">1대</span>
                </li>
                <li className="flex items-center justify-between p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
                  <span className="font-bold text-slate-700">Twin Screw (70mm)</span>
                  <span className="text-slate-500 font-medium">2대</span>
                </li>
              </ul>
            </div>
            ...
            <div className="p-10 rounded-3xl bg-slate-900 text-white shadow-xl">
              <div className="flex items-center mb-8">
                ...
                <h3 className="text-2xl font-bold">연구/실험 장비 (Lab)</h3>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700/50 font-medium text-slate-200">Izod 충격측정기</div>
                <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700/50 font-medium text-slate-200">인장 및 굴곡시험기</div>
                <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700/50 font-medium text-slate-200">MI (용융지수) 측정기</div>
                <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700/50 font-medium text-slate-200">Notch기</div>
                <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700/50 font-medium text-slate-200">색차기</div>
                <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700/50 font-medium text-slate-200">비중측정기</div>
                <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700/50 font-medium text-slate-200 sm:col-span-2">중금속측정기</div>
              </div>
            </div>
          </div>
        </div>
